...
DROP TABLE IF EXISTS gbp_indicados CASCADE;

-- Create table for indicados
CREATE TABLE gbp_indicados (
...
-- Add unique constraint for CPF within same company
ALTER TABLE gbp_indicados 
ADD CONSTRAINT unique_cpf_per_company UNIQUE (cpf, empresa_id);
